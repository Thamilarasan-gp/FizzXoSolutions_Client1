...
const EventPage = () => {
    ...
    useEffect(() => {
        const checkUserInteractions = () => {
            ...
            const dislikedEvents = JSON.parse(localStorage.getItem('dislikedEvents') || '[]');
    ...
    const handleShare = () => {
        ...
        const whatsappUrl = `https://wa.me/?text=${encodeURIComponent("Check out this event: " + eventUrl)}`;
